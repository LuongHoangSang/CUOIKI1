...
\begin{ex}
	...
	{Vận tốc cực tiểu của chất điểm là $\xsi{-20\pi}{\centi\meter/\second}$}
	...
	\loigiai{
		\begin{itemchoice}
			...
			\itemch Sai. $a_{\min}=-\omega^2A=\xsi{-80\pi^2}{\centi\meter/\second^2}$.
...
\begin{ex}
	...
	\choiceTF[t]
	{Đàn guitar là một ứng dụng của phản xạ sóng âm}
