...
\newcommand{\outfooter}{
	\textbf{\color{purple}Ôn tập cuối học kì I - Vật lý 11} % Tên tài liệu ở footer
}
...
{
	\vspace*{-11pt}
	\hspace*{-1.1pt}\color{purple}\textbf{Lớp Cô Thảo - Thầy Sang} 
}
\fancyfoot[RO] % footer - lề ngoài 
{
	\vspace*{-11pt}
	\color{purple}\textbf{Lớp Cô Thảo - Thầy Sang}\hspace*{-5pt}
}
